---
title: A Good Day to Font Hard
slug: a-good-day-to-font-hard
...
**TL;DR**: I have a metric truckload of links to free-to-use fonts that you might like to be somewhat aware of very much actually.
...
Of course you shouldn’t, for several mind-buggeringly good reasons. Of these, the first two that leap to mind are:

1. It *will* look shit
2. Fonts are someone’s copyrighted work, and if you use them without a license that’s software piracy (or “stealing”[^stealing], if you prefer)
...
These ones are technically sans-serifs, but they’re a bit different. Come along would you, and let’s have a little look at them just now very much in fact.
...
* [**Anonymous Pro**](https://www.marksimonson.com/fonts/view/anonymous/) by [Mark Simonson](https://www.marksimonson.com/) - [sample](/public/images/2025/12/font-samples/anonymous-pro.png)<br>This was my terminal and coding font for a good five—could be ten actually—years before switching to Monaspace. It ticks all the coding font boxes (no ambiguous characters, legible at small sizes, very clear at larger sizes, supports a wide character set, pleasant to read) and is genuinely a joy to stare at all day.
* [**M+ 1m**](https://mplusfonts.github.io/) by [Coji Morishita](http://www.underforest.com/) - [sample](/public/images/2025/12/font-samples/mplus-1m.png)<br>I still have a zip file of mplus fonts that I downloaded well over a decade ago containing **M+1m** and lots of other variants. The lowercase **m** denotes monospace. I can't seem to track down these exact faces on the web now, but there is [an updated version](https://mplusfonts.github.io/) from the same author which appears to include "**M Plus 1 Code**" which looks similar. This is really good at small sizes, but works fine when you bump it up too.
* [**Julia Mono**](https://juliamono.netlify.app/) by [Cormullion](https://github.com/cormullion/) - [sample](/public/images/2025/12/font-samples/julia-mono.png)<br>Julia Mono is a code font that features "a wide range of specialist and technical Unicode characters", and they really are not kidding. Each TTF file is ~3.2MB and contains over 12,000 glyphs, where Monaspace Argon (for example) has 785 glyphs. If you want to cover all the bases, or your online technical documentation uses an unholy range of special characters, then Julia Mono has you covered. (If not, think about whether you want to make your users download ~13MB of font files...)
* [**Clack**](https://wehtt.am/fonts/#fonts) by [Matthew Hinders-Anderson](https://wehtt.am) - [sample](/public/images/2025/12/font-samples/clack.png)<br>Matthew's fonts are on time, every time, and his monospace is no exception.
...
…but in the name of all the saints and sinners, go easy would you? A little script goes a *very* long way.

---

## Type Free or Font Hard

Let’s just remember why we’re here, n’est-ce pas? Fonts/typefaces are copyright[^copyright], and you need a license to use them. Someone put a lot of work into [DIN](https://en.wikipedia.org/wiki/FF_DIN), and Helvetica Neue, and [Proxima Nova](https://www.marksimonson.com/fonts/view/proxima-nova/), and [Kora](https://whymoreart.com/product/kora-font-slab-serif-font/), and [Wensley](https://creativemarket.com/creativetacos/2507065-Wensley-Modern-Serif-Font-Family), just like I put a lot of work into writing and making music. It’s easy to forget that you are using a piece of software that someone else toiled over when you’re slapping a title onto a flyer in Photoshop or cooking up a dank meme[^meme] in… whatever the kids use, and scrolling through 1000s of typefaces looking for the one that will pop.
...
[^literally]: Literally
[^typefaces]: “Fonts” and “typefaces” are subtly different things – [a typeface is a font family, which can contain several fonts](https://www.geeksforgeeks.org/websites-apps/difference-between-typeface-and-font/). Now you know.
[^all-os]: Both
[^both-os]: Windows and Mac (but no-one had a Mac)
[^all-browser]: Both
[^both-browser]: IE and Netscape (but no-one used Netscape)
[^several]: Two
[^literally-again]: Not literally
[^stealing]: I think it's fairly well known now that [the infamous “You Wouldn’t Steal a Car” anti-piracy ads](https://en.wikipedia.org/wiki/You_Wouldn't_Steal_a_Car) on TV in the mid-2000s did in fact themselves [use a pirated font](https://news.sky.com/story/you-wouldnt-steal-a-font-famous-anti-piracy-campaign-may-have-used-pirated-typeface-13357462), which is moderately hilarious
[^times]: Well technically it’s “Times” not “Times New Roman”, but that’s really splitting hairs at this stage
[^not]: No
...
[^the-hateful-eight]: Sourced via my own memory and [Core fonts for the web](https://en.wikipedia.org/wiki/Core_fonts_for_the_Web) on Wikipedia. I discounted Andalé Mono because it was not installed on Macs of the time. I discounted Arial Black because it was basically Arial, and was not on older Macs. I discounted Webdings because it's Webdings.
